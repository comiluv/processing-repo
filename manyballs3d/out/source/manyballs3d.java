...
public class manyballs3d extends PApplet {
...
class Ball
{
	...
	public void collide(Ball otherBall)
	{
		...
		if (d <= (size + otherBall.size) / 2 && PVector.dot(PVector.sub(vel, otherBall.vel), PVector.sub(otherBall.pos, pos)) > 0)
		{
			...
			//tempy = vel.y;
			//println("collide!");
			hu1 = PApplet.parseInt(random(255));
			hu2 = PApplet.parseInt(random(255));
			hu3 = PApplet.parseInt(random(255));
			otherBall.hu1 = hu1;
			otherBall.hu2 = hu2;
			otherBall.hu3 = hu3;
...
//        / (mass + otherBall.mass);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "manyballs3d" };
    if (passedArgs != null) {
